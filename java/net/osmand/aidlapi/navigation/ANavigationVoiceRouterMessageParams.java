...
/**
 * The subscription request for registerForVoiceRouterMessages: a callback id and a flag.
 *
...
public class ANavigationVoiceRouterMessageParams extends AidlParams {
    ...
    public static final Creator<ANavigationVoiceRouterMessageParams> CREATOR = new Creator<ANavigationVoiceRouterMessageParams>() {
        @Override public ANavigationVoiceRouterMessageParams createFromParcel(Parcel in) { return new ANavigationVoiceRouterMessageParams(in); }
        @Override public ANavigationVoiceRouterMessageParams[] newArray(int size) { return new ANavigationVoiceRouterMessageParams[size]; }
    };
